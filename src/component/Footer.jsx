  ...
  return (
    ...
    className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
        ...
        <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
            ...
            viewport={{once: true}}
            className='space-y-5 text-gray-700 text-sm dark:text-gray-400'>
        ...
        viewport={{once: true}}
        className='flex justify-center sm:justify-between pb-6 text-sm text-gray-500 flex-wrap gap-4'>
